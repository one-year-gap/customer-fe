    ...
    <div className="fixed inset-0 z-200 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="animate-in fade-in zoom-in-95 bg-background w-90 rounded-3xl p-6 shadow-2xl">
        ...
        <div className="mt-6 flex gap-3">
          <button
            onClick={onCancel}
            className="bg-background flex-1 cursor-pointer rounded-xl border border-neutral-200 py-2.5 text-sm font-semibold text-neutral-700 transition hover:bg-neutral-100">
            취소
          </button>

          <button
            onClick={onConfirm}
            className="bg-secondary-500 hover:bg-secondary-700 text-neutral-0 flex-1 cursor-pointer rounded-xl py-2.5 text-sm font-semibold shadow-md transition">
            변경하기
          </button>
        </div>
      </div>
